        ...
        get synchronization() {
            return {
                onDidOpenNotebookDocument: (handler) => {
                    this.connection.onNotification(vscode_languageserver_protocol_1.Proposed.DidOpenNotebookDocumentNotification.type, (params) => {
                        handler(params);
                    });
                },
                onDidChangeNotebookDocument: (handler) => {
                    this.connection.onNotification(vscode_languageserver_protocol_1.Proposed.DidChangeNotebookDocumentNotification.type, (params) => {
                        handler(params);
                    });
                },
                ...
                onDidCloseNotebookDocument: (handler) => {
                    this.connection.onNotification(vscode_languageserver_protocol_1.Proposed.DidCloseNotebookDocumentNotification.type, (params) => {
                        handler(params);
                    });
                }
            };
